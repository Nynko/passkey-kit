...
export interface Client {
   ...
   */
  add: ({signer, recovery}: {signer: Signer, recovery: Recovery}, options?: {
    /**
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "AAAAAAAAAAAAAAADYWRkAAAAAAIAAAAAAAAABnNpZ25lcgAAAAAH0AAAAAZTaWduZXIAAAAAAAAAAAAIcmVjb3ZlcnkAAAfQAAAACFJlY292ZXJ5AAAAAQAAA+kAAAPtAAAAAAAAAAM=",
