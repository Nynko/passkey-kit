...
use smart_wallet_interface::{types::{Signatures, SignerKey}, PolicyInterface};
use soroban_sdk::{
...
impl PolicyInterface for Contract {
    fn policy__(env: Env, _source: Address, _signer: SignerKey, contexts: Vec<Context>, signatures: Signatures) {
